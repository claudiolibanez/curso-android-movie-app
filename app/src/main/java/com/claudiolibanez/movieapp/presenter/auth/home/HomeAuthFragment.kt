package com.claudiolibanez.movieapp.presenter.auth.home
...
import com.claudiolibanez.movieapp.databinding.FragmentHomeAuthBinding
...
class HomeAuthFragment : Fragment() {
    ...
    private fun initListeners() {
        binding.buttonWithPassword.setOnClickListener {
